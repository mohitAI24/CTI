...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-black via-slate-900 to-blue-900 border-t border-slate-800 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category} className="text-md text-slate-400 px-148">
